# Generated by Django 3.1.7 on 2023-11-30 03:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players_ready', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), default=list, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_module', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='submodules', to='app.module')),
            ],
        ),
        migrations.CreateModel(
            name='MultiToken',
