# To start the docker container for the frontend you need to take the following steps. If you don't have docker/docker-compose you need to install it. I will leave you the links bellow to install Docker.
* Docker for Linux:
